...
<template>
  <div class="relative w-[66px] h-[78px] xl:w-[81px] xl:h-[95px] cursor-pointer">
    <!-- Background -->
    <div class="absolute top-0 right-0 bottom-0 left-0">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 81 95">
        <path
          fill="#10161ADB"
    ...
    <!-- Modifier Button -->
    <div
      class="relative text-[18px] xl:text-[26px] text-center text-white font-bold xl:font-medium"
    >
      <button
        :class="`relative h-[26px] xl:h-[34px] w-[48px] xl:w-[60px] mx-auto flex-center rounded-[4px] button-${className}`"
      >
