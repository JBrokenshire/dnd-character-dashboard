...
<template>
  ...
  >
    ...
    <div class="w-[4.5rem] h-[3.3125rem] flex-center relative">
      <!-- Background -->
      <div class="absolute top-0 bottom-0 right-0 left-0 overflow-hidden">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 72 54"
          class="ddbc-svg ddbc-inspiration-box-svg"
        >
          <defs>
            <polygon
          ...
          >
            ...
            >
              <g id="InspirationBoxSvg-Page-1" transform="translate(1484.000000, 280.000000)">
                <polygon
      ...
      <div v-if="inspiration" class="relative h-[1.25rem] w-[2.1875rem]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 50 30"
          class="ddbc-svg ddbc-inspiration-token-svg"
        >
          <g>
            <path
              :class="className"
    ...
    <!-- Title -->
    <div
      class="text-center w-[4.375rem] pt-[.75rem] text-[.75rem] font-bold text-white uppercase tracking-tightest outlined-text"
    >
      Heroic Inspiration
    </div>
  </section>
