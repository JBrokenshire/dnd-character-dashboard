    ...
    <div class="relative w-[5px]">
      <span v-if="proficient" aria-label="Proficient">
        <svg
          ...
          viewBox="0 0 10 10"
          class="w-[10px] h-[10px] absolute inline-flex left-[-4px] top-[-50%] translate-y-[-50%] rounded-full border border-dotted border-cs-gray"
        >
          <g data-name="Layer 2">
            <g data-name="v1">
      ...
      <span v-else aria-label="Not Proficient">
        <span
          class="absolute inline-flex bg-cs-gray-dark rounded-full -left-[4px] top-[-50%] translate-y-[-50%] h-[10px] w-[10px] border border-dotted border-cs-gray"
        />
      </span>
    </div>
