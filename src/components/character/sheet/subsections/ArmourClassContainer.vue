...
<template>
  <div class="w-[85px] xl:w-[105px] pt-[2px] xl:pt-0 relative">
    <div
      class="w-[79px] h-[90px] xl:w-[90px] xl:h-[95px] mx-auto flex flex-col justify-center font-bold leading-[1] text-center uppercase"
    >
      <div class="svg-background">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 79 90" class="w-full h-full">
          <path
            fill="#10161ADB"
      ...
      <div class="text-cs-gray relative text-[10px]">Armour</div>
      <div class="relative text-[26px] text-white">{{ armourClass }}</div>
      <div class="text-cs-gray relative text-[10px]">Class</div>
    </div>
  </div>
</template>
